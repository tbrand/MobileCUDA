 ...
 */
#define NVML_API_VERSION            5
#define NVML_API_VERSION_STR        "5"
 ...
 *         - \ref NVML_ERROR_UNINITIALIZED     if the library has not been successfully initialized
 *         - \ref NVML_ERROR_INVALID_ARGUMENT  if \a dev0 or \a dev2 are invalid or \a onSameBoard is NULL
